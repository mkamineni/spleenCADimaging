...
do
    ...
    echo $filenum
    #$count=0
    #for F in $(cat radiomics/IDs_missing_liver.txt); do
    #    count=$((count+1))
    #    echo $count
    #    gsutil -m cp gs://bulkml4h/bodymri/all/raw/${F//[$'\t\r\n']}_20201_2_0.zip data/${F//[$'\t\r\n']}_20201_2_0.zip
    #done
    #gsutil -m cp gs://bulkml4h/bodymri/all/raw/*_3_0.zip data/

    #gsutil ls gs://bulkml4h/bodymri/all/raw/*_3_0.zip | head -n $filenum | tail -n $increment | gsutil -m cp -I data/
    ...
    #python convert2nnunet.py --nifti_folder stitched_data/ --nnunet_folder nnunet_data/ --dataset_name ukbb --num_channels 4 < answers.txt
    ...
    #python predict.py --nnunet_folder nnunet_data/ --prediction_folder predictions/ --dataset_name ukbb --num_channels 4 \
