...
def main():
    ...
    parser.add_argument('--num_channels', type=int, required=True, choices=[1, 4], help='Number of channels.')
    parser.add_argument('--num_threads_preprocessing', type=int, required=True, choices=[1, 12], help='Number of threads to process. Up to 12')
    parser.add_argument('--num_threads_nifti_save', type=int, required=True, choices=[1, 4], help='Number of threads to nifti save.')
    parser.add_argument('--disable_tta', type=int, required=False, default=True, help='disable tta.')
    ...
    logging.info('num_threads_preprocessing: {0}\n'.format(num_threads_preprocessing))
    logging.info('num_threads_nifti_save: {0}\n'.format(num_threads_nifti_save))
